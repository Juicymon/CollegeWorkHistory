...
def scientific():
    ...
    # All functions for the scientific calculator were written using the included math functions
    if op == '^':
        return str(a) + op + str(b) + ' = ' + str(a**b)
    elif op == '%':
        if b == 0:
        ...
        return str(a) + ' ^ (1/' + str(b) + ') = ' + str(a**(1/b))
    elif op == '!':
        return op + str(a) + ' = ' + str(math.factorial(a))
    elif op == 'sin':
