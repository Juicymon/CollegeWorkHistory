...
public class ShoppingListArrayListTest {
    ...
    public void testAdd() {
        ...
        //Test adding a duplicate item to the list
        try {
            instance.add(item2);
            assertTrue(instance.size() == 1);
            assertTrue(instance.find(0).getQuantity() == 5);
        } catch (Exception e) {
            assertTrue(0 == 1);
        }
    ...
    public void testRemove() {
        ...
        //test if the item is removed properly
        isRemoved = instance.remove(item1);
        assertTrue(isRemoved == true);
        assertTrue(instance.size() == 1);
        assertTrue(instance.contains(item1) == false);
       ...
       //test removing non-existant item
       isRemoved = instance.remove(item1);
        assertTrue(isRemoved == false);
        assertTrue(instance.size() == 1);
        assertTrue(instance.contains(item2) == true);
    ...
    public void testFind() {
        ...
        //Test case of trying to find item in empty collection
         try {
        ...
        //Test case where index is greater than number of items in list
        try {
            Grocery item = instance.find(3);
            assertTrue(0 == 1);
        } catch (EmptyCollectionException ex) {
            assertTrue(0 == 1);
        } catch (IndexOutOfBoundsException ex){
